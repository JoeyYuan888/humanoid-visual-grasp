...
4. Save data/runtime/mpc_locked_target_latest.json while the neck TF is still low.
...
from robot_grasp.common.grasp_flow import object_conf, summarize_target
...
def _run_vision(ws_url: str, seconds: float, preferred_label: str,
    ...
    csv_path = logger.save(os.path.join(PROJECT_ROOT, "data", "samples"))
