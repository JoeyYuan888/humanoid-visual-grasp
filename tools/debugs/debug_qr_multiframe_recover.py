...
from tools.debugs.debug_qr_recover_pipeline import (
    _decode,
    _detect_quads,
    _enhance_variants,
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default=str(PROJECT_ROOT / "data" / "qr_multiframe_debug"),
    )
    ...
    parser.add_argument(
        "--result-output",
        default=str(PROJECT_ROOT / "data" / "post_grasp_qr_latest.json"),
