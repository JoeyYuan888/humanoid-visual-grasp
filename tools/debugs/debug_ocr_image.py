...
用法:
    python tools/debugs/debug_ocr_image.py <图片路径/目录>

示例:
    python tools/debugs/debug_ocr_image.py test.jpg
    python tools/debugs/debug_ocr_image.py data/          # 批量测试目录下所有图片
...
from tools.ocr_detector import (
    OCRDetector,
    OCRWorker,
    draw_ocr_detections,
    _ensure_dict,
...
DEFAULT_DEBUG_DIR = os.path.join(PROJECT_ROOT, "data", "ocr_label_debug", "latest")
