...
from tools.ocr_detector import OCRDetector, draw_ocr_detections, _WARD_LIST, _find_qr_finders, _ocr_correct
...
DEFAULT_SNAPSHOT = os.path.join(PROJECT_ROOT, "data", "post_grasp_qr_snapshot.png")
DEFAULT_ROI_SNAPSHOT = os.path.join(PROJECT_ROOT, "data", "post_grasp_qr_roi.png")
...
def _run_offline_recover(args) -> bool:
    ...
    cmd = [
        sys.executable,
        "tools/debugs/debug_qr_multiframe_recover.py",
        "--input-dir",
...
def _filter_ocr_detections(args, detections: list[dict]) -> list[dict]:
    ...
    def normalize_ward(text: str) -> str | None:
        ...
        if ward_pattern.search(text):
            ...
            return corrected if corrected in _WARD_LIST else text
